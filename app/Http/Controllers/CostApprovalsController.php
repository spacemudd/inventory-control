...
class CostApprovalsController extends Controller
{
    ...
    */
    ...
    public function toPurchaseOrder($id)
    {
        ...
        $po->approver_one_id = optional(Employee::where('name', 'LIKE', '%Waleed Al Shubeyan%')->first())->id;
        $po->approver_two_id = optional(Employee::where('name', 'LIKE', 'Haitham AbdulRahman Al Koblan')->first())->id;
        $po->save();
