...
class CostApprovalsController extends Controller
{
    ...
    */
    ...
    public function toPurchaseOrder($id)
    {
        ...
        $po->approver_one_id = optional(Employee::where('name', 'LIKE', '%Saleh N. Al-Zunaidi%')->first())->id;
        $po->approver_two_id = optional(Employee::where('name', 'LIKE', 'Ashraf Saeed')->first())->id;
        $po->save();
