...
class ContractsUploadsController extends Controller
{
    public function index(Request $request)
    {
		...
		$uploads = Contract::findOrFail($request->id)->media()->with('user')->get();
        return $uploads;
    } 
    ...
    public function store(Request $request)
    {
        ...
        $savedFiles = DB::transaction(function() use ($request) {
            ...
            $po =  Contract::where('id', $request->input('id'))->firstOrFail();
