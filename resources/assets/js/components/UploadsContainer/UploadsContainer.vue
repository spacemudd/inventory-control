                    ...
                    <div class="content">
                        ...
                        <p>
                            ...
                            <small>
                                ...
                                <button v-if="canDeleteInvoiceAttachements" class="button is-small is-danger is-pulled-right has-icon" @click="confirmDelete(upload.id) ">
